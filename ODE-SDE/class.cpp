       ...
       // #else
        ...
        void  SystEq::SolveSDEEuler(double h,double perc1,double perc2,double Max_Time,int Max_Run,bool Info,double Print_Step,char *argv){
            ...
            void  SystEq::SolveODE45(double h, double perc1,double Max_Time,bool Info,double Print_Step,char *argv){
                ...
                //k6
                long double k7[nPlaces];
                     
                long double ValueA1[nPlaces];
                
                const long double C3d40 = 3.0/40.0;
                const long double C9d40 = 9.0/40.0;
                const long double C40d45 =40.0/45.0;
                const long double C56d15 =56.0/15.0;
                const long double C32d9 =32.0/9.0;
                const long double C19372d6561 =19372.0/6561.0;
                const long double C25360d2187 =25360.0/2187.0;
                const long double C64448d6561 =64448.0/6561.0;
                const long double C212d729	=212.0/729.0;
                const long double C9017d3168 =9017.0/3168.0;
              ...
              /*      //Initialize current step
                ...
                */    
                    ...
                    long double delta  = 0.84 *std::pow((long double )fabs(perc1/(error)), 2.0);

...
public:
    arco(vertice *a = 0, vertice *b = 0, double costo = 0)
        : sorg(a),
          dest(b),
          costo(costo)
    {}
...
public:
    ...
    adiacente(vertice *vert = 0, double c = 0)
        : vertex(vert),
          costo(c)
    {}
...
public:  // operazioni
    ...
    arco *aggiungiArco(vertice *x, vertice *y, double costo);
...
*/
arco *Grafo::aggiungiArco(vertice *x, vertice *y, double costo = 1) {

...
public class CppFormat {
	 ...
	 */
		...
		private static String generateFBAClass() {
			...
			//	sb.append("        return 0; // Return the calculated rate\n");
				sb.append("        if (!init) {\n");
				...
				sb.append("                        std::cout << \"[updateFluxBounds] Adding problemIndex=\" << prob \n");
				sb.append("                                  << \" for metabolite=\" << metabolite << std::endl;\n");
				sb.append("                    }\n");
				sb.append("                }\n");
				sb.append("            }\n");
				sb.append("        }\n");
				...
				sb.append("            std::cout << \"[updateFluxBounds] Processing problemIndex=\" << problemIndex << std::endl;\n");
				sb.append("\n");
				...
				sb.append("                    std::cout << \"[updateFluxBounds] Reaction=\" << reaction \n");
				sb.append("                              << \" not found in problemIndex=\" << problemIndex << std::endl;\n");
				sb.append("                    continue;\n");
				sb.append("                }\n");
				sb.append("\n");
				...
				sb.append("                }\n");
				sb.append("                std::cout << \"[updateFluxBounds] Reaction=\" << reaction \n");
				sb.append("                          << \" isReverse=\" << isReverse << std::endl;\n");
				...
				sb.append("                std::cout << \"[updateFluxBounds] Reaction=\" << reaction \n");
				sb.append("                          << \" concentration=\" << conc << std::endl;\n");
				sb.append("\n");
				...
				sb.append("            					std::cout << \"[updateFluxBounds] Reaction=\" << reaction << \" multiplicativeConstant=\" << lambda << std::endl;\n");
				sb.append("\n");
				...
				sb.append("        					}\n");
				sb.append("\n");
				sb.append("       					std::cout << \"[updateFluxBounds] Reaction=\" << reaction << \" fluxMaxCandidate=\" << fluxMaxCandidate << std::endl;\n");
				sb.append("\n");
				...
				sb.append("       					}\n");
				sb.append("\n");
				sb.append("       					std::cout << \"[updateFluxBounds] Reaction=\" << reaction << \" oldUb=\" << oldUb << std::endl;\n");
				sb.append("\n");
				sb.append("        					double newUb = fluxMaxCandidate;\n");
				sb.append("        					std::cout << \"[updateFluxBounds] Reaction=\" << reaction << \" newUb=\" << newUb << std::endl;\n");
				sb.append("\n");
				sb.append("        					double Lb = 0.0;\n");
				sb.append("        					if (newUb <= Lb) {\n");
				sb.append("            					vec_fluxb[problemIndex].update_bound(colIdx, \"GLP_FX\", Lb, Lb);\n");
				sb.append("           					std::cout << \"[updateFluxBounds] Reaction=\" << reaction << \" GLP_FX UB=\" << Lb << std::endl;\n");
				sb.append("        					} else {\n");
				sb.append("            					vec_fluxb[problemIndex].update_bound(colIdx, \"GLP_DB\", Lb, newUb);\n");
				sb.append("            					std::cout << \"[updateFluxBounds] Reaction=\" << reaction << \" GLP_DB UB=\" << newUb << std::endl;\n");
				sb.append("        					}\n");
				sb.append("            }\n");
				sb.append("        }\n");
				sb.append("    }\n");
				...
				sb.append("        std::cout << \"[computeRate] Transition Name: \" << transitionName << std::endl;\n");
				sb.append("\n");
				sb.append("        int problemIndex = FBAproblems[transitionName];\n");
				sb.append("        std::cout << \"[computeRate] Problem Index: \" << problemIndex << std::endl;\n");
				sb.append("\n");
				sb.append("        int varIndex = vec_fluxb[problemIndex].fromNametoid(FBAreact[transitionName]);\n");
				sb.append("        std::cout << \"[computeRate] Variable Index (from reaction): \" << varIndex << \" with name ---> \" << FBAreact[transitionName] << std::endl;\n");
				sb.append("\n");
				sb.append("        double rate = Vars[problemIndex][varIndex];\n");
				sb.append("        std::cout << \"[computeRate] Initial Rate: \" << rate << std::endl;\n");
				sb.append("\n");
				...
				sb.append("            std::cout << \"[computeRate] Current Biomass: \" << currentBiomass << std::endl;\n");
				sb.append("        }\n");
				sb.append("\n");
				...
				sb.append("            std::cout << \"[computeRate] Biomass Rate: \" << rate << \" with Reaction: \" << FBAreact[transitionName] << std::endl;\n");
				...
				sb.append("            constant = floor(Value[NumPlaces.at(problemBacteriaPlace.at(problemIndex))]);\n");
				sb.append("            std::cout << \"[computeRate] Constant (Population): \" << constant << std::endl;\n");
				sb.append("        }\n");
				sb.append("\n");
				sb.append("\n");
				sb.append("        if (hasBioMASS) {\n");
				sb.append("            rate = rate * (constant * currentBiomass * scalingFactor);\n");
				sb.append("            std::cout << \"[computeRate] Final Rate After Scaling: \" << rate << std::endl;\n");
				sb.append("        }\n");
				sb.append("\n");
				sb.append("        std::cout << \"[computeRate] Returning Rate: \" << rate << std::endl;\n");
				sb.append("        return rate;\n");
				sb.append("    }\n");
				...
				sb.append("            std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Processing line: \" << line << std::endl;\n");
				...
				sb.append("            std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Extracted reactionName: \" << reactionName << std::endl;\n");
				sb.append("\n");
				sb.append("            // 2) Extract the numeric fields\n");
				sb.append("            while (getline(ss, boundStr, ',')) {\n");
				sb.append("                bounds.push_back(stod(boundStr));\n");
				sb.append("                std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Extracted bound value: \" << boundStr << std::endl;\n");
				sb.append("            }\n");
				sb.append("\n");
				...
				sb.append("                std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Reaction found in reactionToFileMap: \" << reactionName\n");
				sb.append("                          << \" with problemIndices.size(): \" << problemIndices.size() << std::endl;\n");
				sb.append("\n");
				...
				sb.append("                        std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Reaction ID not found for reaction: \" << reactionName << \" in problemIndex: \" << problemIndex << std::endl;\n");
				sb.append("                        continue;\n");
				sb.append("                    }\n");
				sb.append("\n");
				sb.append("                    if (problemIndex >= bounds.size()) {\n");
				sb.append("                        std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Error: problemIndex \" << problemIndex << \" exceeds bounds.size() for reaction: \" << reactionName << std::endl;\n");
				sb.append("                        continue;\n");
				sb.append("                    }\n");
				sb.append("\n");
				sb.append("                    // Use the correct value from bounds\n");
				sb.append("                    double newUb = bounds[problemIndex];\n");
				sb.append("                    std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Reaction: \" << reactionName << \" newUb: \" << newUb << \" for problemIndex: \" << problemIndex << std::endl;\n");
				sb.append("\n");
				sb.append("                    // Retrieve the current lower bound\n");
				sb.append("                    double currentLb = vec_fluxb[problemIndex].getLwBounds(reactionId);\n");
				sb.append("                    std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Reaction: \" << reactionName << \" currentLb: \" << currentLb << \" for problemIndex: \" << problemIndex << std::endl;\n");
				sb.append("\n");
				...
				sb.append("                    );\n");
				sb.append("                    std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Updated bounds for reaction: \" << reactionName\n");
				sb.append("                              << \" currentLb: \" << trunc(currentLb, decimalTrunc)\n");
				sb.append("                              << \" newUb: \" << trunc(newUb, decimalTrunc) << std::endl;\n");
				sb.append("                }\n");
				sb.append("            } else {\n");
				sb.append("                std::cout << \"[updateNonFBAReactionUpperBoundsFromFile] Reaction \" << reactionName << \" not found in reactionToFileMap.\" << std::endl;\n");
				sb.append("            }\n");
				sb.append("        }\n");
				sb.append("\n");
				sb.append("        file.close();\n");
				...
				sb.append("        string line;\n");
				sb.append("        while (getline(file, line)) {\n");
				sb.append("            std::cout << \"[loadAndApplyFBAReactionUpperBounds] Processing line: \" << line << std::endl;\n");
				sb.append("            istringstream ss(line);\n");
				...
				sb.append("            std::cout << \"[loadAndApplyFBAReactionUpperBounds] Extracted reaction: \" << reaction << std::endl;\n");
				sb.append("\n");
				sb.append("            // 2) Extract the numeric fields\n");
				sb.append("            while (getline(ss, boundStr, ',')) {\n");
				sb.append("                bounds.push_back(stod(boundStr));\n");
				sb.append("                std::cout << \"[loadAndApplyFBAReactionUpperBounds] Extracted bound value: \" << boundStr << std::endl;\n");
				sb.append("            }\n");
				sb.append("\n");
				sb.append("            // 3) Check if the reaction exists in reactionToFileMap\n");
				...
				sb.append("            if (it != reactionToFileMap.end()) {\n");
				sb.append("                const auto& problemIndices = it->second;\n");
				sb.append("                std::cout << \"[loadAndApplyFBAReactionUpperBounds] Reaction found in reactionToFileMap: \" << reaction\n");
				sb.append("                          << \" with problemIndices.size(): \" << problemIndices.size() << std::endl;\n");
				sb.append("\n");
				sb.append("                // 4) Update the bounds\n");
				sb.append("                size_t i = 0;\n");
				...
				sb.append("                    if (reactionId == -1) {\n");
				sb.append("                        std::cout << \"[loadAndApplyFBAReactionUpperBounds] Reaction ID not found for reaction: \" << reaction << \" in problemIndex: \" << problemIndex << std::endl;\n");
				sb.append("                        continue;\n");
				sb.append("                    }\n");
				sb.append("\n");
				sb.append("                    if (problemIndex >= bounds.size()) {\n");
				sb.append("                        std::cout << \"[loadAndApplyFBAReactionUpperBounds] Error: problemIndex \" << problemIndex << \" exceeds bounds.size() for reaction: \" << reaction << std::endl;\n");
				sb.append("                        continue;\n");
				sb.append("                    }\n");
				sb.append("\n");
				sb.append("                    // Use the correct value from bounds\n");
				sb.append("                    double newUb = bounds[problemIndex];\n");
				sb.append("                    std::cout << \"[loadAndApplyFBAReactionUpperBounds] Reaction: \" << reaction << \" newUb: \" << newUb << \" for problemIndex: \" << problemIndex << std::endl;\n");
				sb.append("\n");
				sb.append("                    // Retrieve the current lower bound\n");
				sb.append("                    double currentLb = vec_fluxb[problemIndex].getLwBounds(reactionId);\n");
				sb.append("                    std::cout << \"[loadAndApplyFBAReactionUpperBounds] Reaction: \" << reaction << \" currentLb: \" << currentLb << \" for problemIndex: \" << problemIndex << std::endl;\n");
				sb.append("\n");
				sb.append("                    // Update bounds\n");
				sb.append("                    vec_fluxb[problemIndex].update_bound(\n");
				sb.append("                        reactionId,\n");
				...
				sb.append("                        trunc(newUb, decimalTrunc)\n");
				sb.append("                    );\n");
				sb.append("                    std::cout << \"[loadAndApplyFBAReactionUpperBounds] Updated bounds for reaction: \" << reaction\n");
				sb.append("                              << \" currentLb: \" << trunc(currentLb, decimalTrunc)\n");
				sb.append("                              << \" newUb: \" << trunc(newUb, decimalTrunc) << std::endl;\n");
				sb.append("                }\n");
				sb.append("            } else {\n");
				sb.append("                std::cout << \"[loadAndApplyFBAReactionUpperBounds] Reaction \" << reaction << \" not found in reactionToFileMap.\" << std::endl;\n");
				sb.append("            }\n");
				sb.append("        }\n");
				sb.append("\n");
				sb.append("        file.close();\n");
				...
				sb.append("\n");
				sb.append("                    // Salviamo la coppia (reaction, index) => ub\n");
				sb.append("                    // cosi distinguiamo la stessa reazione su specie diverse\n");
				sb.append("                    NonFBAReactionBaseUB[ std::make_pair(reaction, index) ] = ub;\n");
				sb.append("\n");
				sb.append("                    // Debug: stampo il valore salvato\n");
				sb.append("                    std::cout << \"[initializeNonFBAReactionsBaseUB] Reaction=\" \n");
				sb.append("                              << reaction << \" (problemIndex=\" << index \n");
				sb.append("                              << \") BaseUB=\" << ub << std::endl;\n");
				sb.append("                }\n");
				sb.append("            }\n");
				sb.append("        }\n");
				sb.append("    }\n");
				...
				sb.append("            if (FBAreactions.find(reaction) != FBAreactions.end()) {\n");
				sb.append("                std::cout << \"[updateNonFBAReactionsUB] Skipping FBA reaction: \" << reaction << std::endl;\n");
				sb.append("                continue;\n");
				sb.append("            }\n");
				sb.append("\n");
				sb.append("            const auto& problemIndices = reactionEntry.second;\n");
				...
				sb.append("                int reactionId = vec_fluxb[index].fromNametoid(reaction);\n");
				sb.append("                if (reactionId == -1) {\n");
				sb.append("                    std::cout << \"[updateNonFBAReactionsUB] Reaction ID not found for reaction: \" << reaction << \" in problemIndex: \" << index << std::endl;\n");
				sb.append("                    continue;\n");
				sb.append("                }\n");
				sb.append("\n");
				sb.append("                string placeName = problemBacteriaPlace[index];\n");
				sb.append("                double pop = floor(Value[NumPlaces.at(placeName)]);\n");
				sb.append("                std::cout << \"[updateNonFBAReactionsUB] Reaction=\" << reaction\n");
				sb.append("                          << \" problemIndex=\" << index\n");
				sb.append("                          << \" population=\" << pop << std::endl;\n");
				sb.append("\n");
				...
				sb.append("                    std::cout << \"[updateNonFBAReactionsUB] Reaction=\" << reaction\n");
				sb.append("                              << \" problemIndex=\" << index\n");
				sb.append("                              << \" => population=0 => UB=0\" << std::endl;\n");
				sb.append("                    continue;\n");
				sb.append("                }\n");
				sb.append("\n");
				...
				sb.append("                std::cout << \"[updateNonFBAReactionsUB] Reaction=\" << reaction\n");
				sb.append("                          << \" problemIndex=\" << index\n");
				sb.append("                          << \" baseUb=\" << baseUb << std::endl;\n");
				sb.append("\n");
				sb.append("                double newUb = pop / baseUb;\n");
				sb.append("                if (pop == 0) {\n");
				sb.append("                    newUb = 0.0; // Evita divisioni per zero\n");
				sb.append("                }\n");
				sb.append("\n");
				sb.append("                vec_fluxb[index].update_bound(\n");
				sb.append("                    reactionId, \"GLP_DB\",\n");
				sb.append("                    0.0, newUb\n");
				sb.append("                );\n");
				sb.append("                std::cout << \"[updateNonFBAReactionsUB] Updated Reaction=\" << reaction\n");
				sb.append("                          << \" problemIndex=\" << index\n");
				sb.append("                          << \" newUb=\" << newUb << std::endl;\n");
				sb.append("            }\n");
				sb.append("        }\n");
				sb.append("    }\n");
				...
				sb.append("            std::cout << \"[updateAllBiomassReactionsUpperBounds] BioMax: \" << BioMax << \", CurrentBiomass: \" << CurrentBiomass << \", BioMin: \" << BioMin << std::endl;\n");
				sb.append("\n");
				sb.append("            double Gamma = BioMax - CurrentBiomass;\n");
				sb.append("            std::cout << \"[updateAllBiomassReactionsUpperBounds] Gamma (BioMax - CurrentBiomass): \" << Gamma << std::endl;\n");
				sb.append("\n");
				...
				sb.append("                std::cout << \"[updateAllBiomassReactionsUpperBounds] CurrentBiomass < BioMin, newUpperBound: \" << newUpperBound << std::endl;\n");
				sb.append("            } else if (Gamma > 0) {\n");
				sb.append("                newUpperBound = Gamma; // Positive Gamma, set upper bound to Gamma\n");
				sb.append("                std::cout << \"[updateAllBiomassReactionsUpperBounds] Gamma > 0, newUpperBound: \" << newUpperBound << std::endl;\n");
				sb.append("            } else {\n");
				sb.append("                newUpperBound = 1e-6; // Gamma not positive, set upper bound to small cutoff\n");
				sb.append("                std::cout << \"[updateAllBiomassReactionsUpperBounds] Gamma <= 0, newUpperBound set to 1e-6.\" << std::endl;\n");
				sb.append("            }\n");
				sb.append("\n");
				...
				sb.append("            std::cout << \"[updateAllBiomassReactionsUpperBounds] Reaction index: \" << index << \", currentLowerBound: \" << currentLowerBound << std::endl;\n");
				sb.append("\n");
				sb.append("            vec_fluxb[problemIndex].update_bound(index, \"GLP_DB\", currentLowerBound, trunc(newUpperBound, decimalTrunc));\n");
				sb.append("            std::cout << \"[updateAllBiomassReactionsUpperBounds] Updated bounds for reaction: \" << reaction << \", newUpperBound: \" << newUpperBound << std::endl;\n");
				sb.append("        }\n");
...
*/
				...
				sb.append("    void performPFBA(vector<class FBGLPK::LPprob>& vec_fluxb, int problemIndex, int geneOption = 1) {\n");
				sb.append("        // -- DEBUG 1: Stampo l'indice del problema e l'obiettivo attuale (FBA classico)\n");
				sb.append("        std::cout << \"[DEBUG performPFBA] problemIndex = \" << problemIndex << std::endl;\n");
				sb.append("        double optimalBiomass = vec_fluxb[problemIndex].getOBJ();\n");
				sb.append("        std::cout << \"    [DEBUG] Biomassa ottimale (FBA) = \" << optimalBiomass << std::endl;\n");
				sb.append("        \n");
				sb.append("        // -- DEBUG 2: Indice della biomassa e suoi bound originali\n");
				...
				sb.append("        std::cout << \"    [DEBUG] biomassIndex = \" << biomassIndex \n");
				sb.append("                  << \", original bounds = [\" << originalLb << \", \" << originalUb << \"], \"\n");
				sb.append("                  << \"originalType (GLP_) = \" << originalType << std::endl;\n");
				sb.append("        \n");
				sb.append("        // Step 1.2: Fisso la biomassa come vincolo\n");
				sb.append("        vec_fluxb[problemIndex].update_bound(biomassIndex, \"GLP_FX\", optimalBiomass, optimalBiomass);\n");
				sb.append("        std::cout << \"    [DEBUG] Fissata reazione biomassa \" << biomassIndex \n");
				sb.append("                  << \" a: \" << optimalBiomass << \" (GLP_FX)\" << std::endl;\n");
				sb.append("        \n");
				sb.append("        // Step 2: Imposto l'obiettivo a minimizzare i flussi\n");
				sb.append("        std::cout << \"    [DEBUG] Invoco setMinimizeFluxObjective(geneOption=\" << geneOption << \")\" << std::endl;\n");
				sb.append("        vec_fluxb[problemIndex].setMinimizeFluxObjective(biomassIndex, geneOption);\n");
				sb.append("        \n");
				...
				sb.append("        std::cout << \"    [DEBUG] Ripristinati bound originali su biomassa: [\" \n");
				sb.append("                  << originalLb << \", \" << originalUb << \"], type=\" << originalType << std::endl;\n");
				sb.append("        \n");
				...
				sb.append("        std::cout << \"    [DEBUG] Obiettivo resettato a massimizzare biomassa.\" << std::endl;\n");
				sb.append("    }\n");

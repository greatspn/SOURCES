...
import common.ContainedIterator;
...
public class MultiNetPage extends ProjectPage implements Serializable, ComposableNet, NodeNamespace {
    ...
    // Descriptor of subnets that will compose this multi-net page
    ...
    public transient ArrayList<NetPage> compSubNets;
    public transient ArrayList<String> subNetPrefixes;
    ...
    public transient ArrayList<NetPage> flattenedSubNets;
    public transient ArrayList<String> flattenedSubNetNames;
    // The composed net
    public transient NetPage compNet;

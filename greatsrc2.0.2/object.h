...
typedef struct drawing_surface_struct {
    GC gc;
    Drawable drawable;
    Display *display;
    Widget widget;
...
typedef DrawingSurface *DrawingSurfacePun;
...
struct trans_object {
    ...
    /* used in firing */ float f_time;
    /* used to show results */ float through1;
    /* used to show results */ float through2;
